...
import { shopifyGetUrlRedirectOauth2 } from 'api/shopify/oauth2/getUrlRedirectOauth2'
...
const scopeOptions = [
  ...
  },
  {
    'label': 'billing_r',
    'value': 'billing_r',
    'description': "Read a member's Shopify bill charges and payments"
  },
  {
    'label': 'cart_r',
    'value': 'cart_r',
...
const RegisterShopifyOauth2 = () => {
  ...
  const onConnectShopify = async () => {
    try {
      ...
      const url = await shopifyGetUrlRedirectOauth2(scopesAr.join(' '), vendor, params?.uuid || null);
    ...
    <div className='misc-wrapper'>
      ...
      <div className='misc-inner p-2 p-sm-3'>
        <div className='w-100 text-center'>
          ...
          <h2 className='mb-1'>Go to connect Shopify Api 🚀</h2>
          <p className='mb-3'>"The term 'Shopify' is a trademark of Shopify, Inc. This application uses the Shopify API but is not endorsed or certified by Shopify, Inc."</p>
          <Form
            tag={Row}
          ...
          ><div className='mb-1'>
            ...
            <Col sm='12' className='d-md-block d-grid ps-md-0 ps-auto'>
              <Button className='mb-1 btn-sm-block' color='primary' onClick={() => onConnectShopify()}>
...
export default RegisterShopifyOauth2
